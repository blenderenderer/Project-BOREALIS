...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Use each 'readfolder' button to tell max where to find your samples – have separate folders for each drum. Then click the bang to populate the lists and save the patch."
				}
