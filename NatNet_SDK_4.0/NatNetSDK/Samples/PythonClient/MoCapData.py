...
client = udp_client.SimpleUDPClient("129.161.36.45", 7500)
...
class MarkerData:
    ...
    def get_as_string(self, tab_str="  ", level=0):
        ...
        for i in range(marker_count):
            ...
            global client
            client.send_message("/marker", [i,pos[0], pos[1], pos[2]])
        return out_str
...
class RigidBody:
    ...
    def get_as_string(self, tab_str=0, level=0):
        ...
        global client
        client.send_message("/marker", [self.id_num, self.pos[0], self.pos[1], self.pos[2]])
...
class LabeledMarker:
    ...
    def get_as_string(self, tab_str, level):
        ...
        global client
        client.send_message("/marker", [marker_id, self.pos[0], self.pos[1], self.pos[2]])
        return out_str
